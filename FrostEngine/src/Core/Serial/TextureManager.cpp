...
namespace frost::core
{
	...
	bool TextureManager::LoadTexture(const std::filesystem::path& path)
	{
	...
	bool TextureManager::LoadTextureMetadata(std::filesystem::path& path, S_TextureData& textureData)
	{
	...
	bool TextureManager::LoadAnimationMetadata(rapidxml::xml_node<>* node, S_TextureData& textureData)
	{
		if (!node)
		{
			return false;
	...
	S_AnimationData::S_AnimationData()
	{

	}

	S_TextureData::S_TextureData()
	{
